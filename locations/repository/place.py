...
def create_place(user_id: uuid.UUID, interest: str) -> int:
    cur.execute(
...
def get_place(interest_id: int) -> Interest | None:
    cur.execute(
...
def update_place(interest_id: int, user_id: uuid.UUID, interest: str) -> int:
    cur.execute(
...
def delete_place(interest_id: int) -> int:
    cur.execute(
